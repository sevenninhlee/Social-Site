<?php
class community_blogs_controller extends right_bar_data_controller
{
	public function index() {
		
        $wheres = ["admin_status" => 0, "owner_status" => 1, 'featured_my_blog' => 1];
		// echo "Start <br/>"; echo '<pre>'; print_r($wheres);echo '</pre>';exit("End Data");
