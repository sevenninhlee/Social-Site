...
<div class="col-md-10 col-sm-9 pad0">
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane tabpane_blogs active" id="queries">
			<p class="must_reads_head">Must Reads</p>
			...
			<ul class="list-inline btn-list_ul">
				...
				<li><a href="<?=vendor_app_util::url(array('ctl'=>'must_reads', 'act' => 'add')); ?>"><button class="btn-custom-apply btn-categories">Add MustReads</button></a></li>
			...
			<table class="table table-striped dataTable" id="must_reads_table" controller="must_reads" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
				<tr>
						...
						<tr role="row" id="row<?=$record['id'];?>">
							...
							<td id="<?php echo("checkbox".$record['id']);?>" class="checkboxRecord btn-act">
								...
								<ul class="list-inline features">
									<li><button id="delItem<?php echo $record['id']; ?>" type="button" class="btn-delete-table delItem-record" alt="<?php echo $record['id']; ?>,deleteMustReadsComment">Delete</button></li>
								</ul>
							</td>
