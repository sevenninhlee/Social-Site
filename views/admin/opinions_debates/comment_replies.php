...
<div class="col-md-10 col-sm-9 pad0">
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane tabpane_opinions_debates active" id="queries">
			<p class="opinion_debate_head">Opinions Debates</p>
			...
			<table class="table table-striped dataTable" id="opinion_debate_table" controller="opinions_debates" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
				...
				<tbody class="tbl_body records">
					<?php if(count($this->records['data'])) { ?>
						<?php $i=1; foreach ($this->records['data'] as $record) { ?>
						<tr role="row" id="row<?=$record['id'];?>">
							...
							<td id="<?php echo("checkbox".$record['id']);?>" class="checkboxRecord btn-act">
								...
								<ul class="list-inline features">
									<li><button id="delItem<?php echo $record['id']; ?>" type="button" class="btn-delete-table delItem-record" alt="<?php echo $record['id']; ?>,deleteOpinionsDebatesComment">Delete</button></li>
								</ul>
							</td>
