    ...
    <div class="row">
                ...
                <?php foreach($this->records['data'] as $key => $record) { ?>
                      <div class="white_box">
                        ...
                        <?php if($record['featured_image']){ ?>
                          <div class="col-sm-5">
                            <div class="img-box">
                              <a href="<?php echo RootURL."community-blogs/".$record['slug']?>" style="color: #333">
                          ...
                          <?php } else { ?>
                            <div class="col-sm-12">
                            <?php } ?>
                            <h3><a href="<?php echo RootURL."community-blogs/".$record['slug'] ?>" style="color: #333"><?php echo $record['title'] ?></a></h3>
                            <p class="cate_txt"> 
                            <span>Category:</span>
                            <?php 
      ...
      <div class="col-md-3">
        ...
        <?php if($newBlog['featured_image']){ ?>
            <div class="img-box">
              <a href="<?php echo RootURL."community-blogs/".$newBlog['slug'] ?>"><img style="max-height: 255x;" src="<?php echo RootREL; ?>media/upload/<?= ($newBlog['featured_image']) ? 'blogs/'.$newBlog['featured_image'] : "no_picture.png" ?>" class="img-responsive" alt="book-3"></a>
            </div>
        <?php } ?>
            <div class="img-desc">
            <h4 class="f700"><a style="color: #333" href="<?php echo RootURL."community-blogs/".$newBlog['slug'] ?>"><?= $newBlog['title'] ?></a></h4>
            <p>Category: 
              <span class="f400">
                <?php 
