...
<ol>
	...
	<li><a href="https://enlight21.com/election_central/candidates-positions-2020-democratic-candidates" >2020 Democratic Party Candidates and Positions</a></li>
</ol></div>
              ...
              <div class="white_box no-padding">
                ...
                <div class="img-desc">
                  ...
                  <p>Category:
                    <span class="f400">
                      <?php
                        if ($newElectionCentral['ListCate'] == null) {
                          echo '<a>Unkown category</a>';
                        } else {
                          $cat_str = "";
                          foreach ($newElectionCentral['ListCate'] as $key => $value) {
                            $cat_str .= $value['name'] . " | ";
                          }
                          echo '<a>' . rtrim($cat_str, " | ") . '</a>';
                        }
