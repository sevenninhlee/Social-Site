    ...
    <div class="row">
        ...
        <div class="white_box">
          <p class="cate_txt">
              ...
              <?php if ($this->record['featured_image']) { ?>
                <img src="<?php echo RootREL; ?>media/upload/<?= ($this->record['featured_image']) ? 'election_central/' . $this->record['featured_image'] : "no_picture.png" ?>" class="img-responsive" alt="baner_new" style="width:100%;height:auto;">
              <?php } ?>
        ...
        <div class="white_box space30 commnet_css_ct">
              ...
              <div class="media heightclass">
                ...
                <div class="media-right" style="width:100%;">
                  ...
                  <ul class="list-inline">
                    ...
                    <li class="pull-right">
                      <p><a class="reply-btn" onclick="showRelyComment(<?= $review['id'] ?>)"><span class="fa fa-comment" style="font-size:16px;margin-right: 5px;">Add Reply</span></a></p>
                    </li>
                    <li class="pull-right forreply_hidden <?= $review['id'] ?>" id="" data_id="<?= $review['id'] ?>" data="0">
                      <p><a class="reply-btn disp-btn-<?= $review['id'] ?>"><span class="fa fa-refresh" style="font-size:16px;margin-right: 5px;">Hidden Reply</span></a></p>
                    </li>
                  </ul>
                  <div class="forreply_at <?= $review['id'] ?>" data="<?= $review['id'] ?>">
                    ...
                    <div class="forreply <?= $review['id'] ?>">
                      ...
                      <div class="text-right">
                        ...
                        <button class="btn btn-review space20 btn_reply" type="button" RootREL="<?php echo RootREL; ?>" checkUser="<?php if ($_SESSION && isset($_SESSION['user']) && isset($_SESSION['user']['id'])) echo true;
                                                                                                                                      else echo false; ?>" data="<?= $review['id'] ?>,<?= $review['object_article_id'] ?>,election_central_article_model">
                          Add reply
                        </button>
                      </div>
                    </div>
          ...
          <form>
            ...
            <div class="form-group text-right">
              <button class="btn btn-review space20 btn_add_comment" type="button" RootREL="<?php echo RootREL; ?>" checkUser="<?php if ($_SESSION && $_SESSION['user'] && $_SESSION['user']['id']) echo true;
                                                                                                                                else echo false; ?>" data="0,<?= ($this->record['id']) ?>,election_central_article_model">
                Add Comment
              </button>
            </div>
          </form>
      ...
      <div class="col-md-3">
        ...
        <?php if (count($this->newElectionCentrals)) { ?>
          <h3 class="f700">New Election Centrals</h3>
        <?php } ?>
