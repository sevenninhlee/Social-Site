  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
        <div class="row">
          <div class="col-sm-7">
            <h2>Environments Page</h2>
          </div>
          <div class="col-sm-5">
            <form id="formClient-blogs-search">
              <div class="input-group">
                <input type="text" class="form-control" name="search" placeholder="Search Environment" value="<?php if (isset($_GET['search'])) {
                                                                                                                        echo $_GET['search'];
                                                                                                                      } ?>">
        ...
        <?php if (!empty($this->records['data'])) : ?>
                ...
                <div class="white_box">
                  <div class="row <?php if ($key >= 1) echo "space30"; ?>">
                    <?php if ($record['featured_image']) { ?>
                      <div class="col-sm-5">
                        <div class="img-box">
                          <a href="<?php echo RootURL . "environment/view/" . $record['slug'] ?>" style="color: #333">
                            <img src="<?php echo RootREL; ?>media/upload/<?= ($record['featured_image']) ? 'environment/' . $record['featured_image'] : "no_picture.png" ?>" class="img-responsive" alt="environment-<?= $record['id'] ?>" style="max-height:177px;">
                          </a>
                        </div>
                      </div>
                      <div class="col-sm-7">
                      <?php } else { ?>
                        ...
                        <p class="cate_txt"> <span>Category:</span>
                          <?php
                              ...
                              ?>
                          <h3><a href="<?php echo (vendor_app_util::url(["ctl" => "environment", "act" => "view/" . $record['slug']])) ?>" style="color: #333"><?php echo $record['title'] ?></a></h3>
                          ...
                          <div class="grey_box">
                            <a href="<?php echo (vendor_app_util::url(["ctl" => "environment", "act" => "view/" . $record['slug']])) ?>"> <span><i class="fa fa-file-text-o" aria-hidden="true"></i></span> Read More</a>
                          </div>
                        </div>
                      </div>
                  </div>
          ...
          <div class="col-md-3">
            ...
            <?php if (count($this->newEnvironments)) { ?>
              <h3 class="f700">New Environments</h3>
            <?php } ?>
            <?php foreach ($this->newEnvironments as $key => $newEnvironment) { ?>
              <div class="white_box no-padding">
                ...
                <div class="img-desc">
                  ...
                  <p>Category:
                    <span class="f400">
                      <?php
                        if ($newEnvironment['ListCate'] == null) {
                          echo '<a>Unkown category</a>';
                        } else {
                          $cat_str = "";
                          foreach ($newEnvironment['ListCate'] as $key => $value) {
                            $cat_str .= $value['name'] . " | ";
                          }
                          echo '<a>' . rtrim($cat_str, " | ") . '</a>';
                        }
