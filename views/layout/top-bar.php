<div class="panel-heading">
    <ul class="nav nav-tabs">
        ...
        <li class="<?=($app['ctl']=='bookshelf_book')? 'active':'';?>"><a href="<?php echo vendor_app_util::url(['area' => 'user','ctl'=>'bookshelf-book?user='.((isset($_GET['user']))?$_GET['user']: $_SESSION['user']['id'] )]); ?>">Bookshelf & Book Reviews</a></li> 
