  ...
  <div class="container">
    <div class="row">
      <div class="col-md-9">
            ...
            <div class="white_box">
              ...
              <?php if($this->record['featured_image']){ ?>
                <img src="<?php echo RootREL; ?>media/upload/<?= ($this->record['featured_image']) ? 'must_reads/'.$this->record['featured_image'] : "no_picture.png" ?>" class="img-responsive" alt="baner_new" style="width:100%;height:auto;">   
              <?php } ?>
                  ...
                  <div class="forreply <?= $review['id'] ?>">
                    ...
                    <div class="text-right">
                      ...
                      <button 
                          ...
                          data="<?= $review['id'] ?>,<?= $review['object_article_id'] ?>,must_reads_article_model"
                      >
                          Add reply
                      </button>                              
                    </div> 
              ...
              <form>
                ...
                <div class="form-group text-right">
                  <button 
                    ...
                    data="0,<?= ($this->record['id']) ?>,must_reads_article_model"
                  >
                      Add Comment 
                  </button>                      
                </div>
      ...
      <div class="col-md-3">
        ...
        <h3 class="f700">New Must Reads</h3>
        <?php } ?>
